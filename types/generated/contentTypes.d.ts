...
export interface ApiCookiePolicyCookiePolicy extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faqs: Schema.Attribute.Component<'shared.shared-faq-item', true>;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    seoMeta: Schema.Attribute.Component<'shared.shared-seo-meta', false>;
...
export interface ApiInsightInsight extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    schemaType: Schema.Attribute.Enumeration<['article', 'review']> &
      Schema.Attribute.Required &
